 ...
 * @author Murthi
 */
public class DRlog extends HttpServlet {
            ...
            try {
                ...
                if (rs1.next()) {
                    ...
                    if (rs.next()) {
                        ...
                        response.sendRedirect("DRHome.jsp?Success");
                    } else {
                        response.sendRedirect("DataReceiver.jsp?not");

                    }
                } else {
                    response.sendRedirect("DataReceiver.jsp?Authentication_Failed");
                }
