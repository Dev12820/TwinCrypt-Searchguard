<%-- 
    Document   : index
    Created on : Jan 13, 2023, 9:17:56 PM
    Author     : Murthi
--%>
                 ...
                 <img class="w-100" src="img/bg.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-4 text-uppercase text-white mb-md-4">Dual-Server Public-Key Authenticated Encryption</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">with Keyword Search</a>
                        </div>
                    </div>
                </div>
            </div>
