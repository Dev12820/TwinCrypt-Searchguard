 ...
 <!-- Page Header Start -->
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Data Receiver</span></h1>
        </div>
        <div class="row gx-0 align-items-center">
            <center><div class="col-lg-6">
                <div class="contact-form bg-light p-5">
                       <form action="DRlog" method="post">
                    <div class="row g-3">
                    ...
                    <br>  <br>  <br>
                    <a href="DRreg.jsp" >Click here for <span><strong style="color: #98380c">New Registration</strong></span></a>
                </div>
                </div></center>
        </div>
    </div>
