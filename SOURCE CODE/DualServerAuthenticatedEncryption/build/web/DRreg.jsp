    ...
    <body>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 mb-4"><span class="text-primary">Data Receiver Registration</span></h1>
            </div>
                        ...
                        <div class="contact-form bg-light p-5">
                            ...
                            <div class="row g-3">
                                <center><div class="col-7">
                                        <input type="text" required="" name="name" class="form-control border-0" placeholder="Your Name" style="height: 55px;">
                                    </div>
                                    <br>
                                    <div class="col-7">
                                    ...
                                    <div class="col-7">
                                        <input type="text" required="" name="phone" class="form-control border-0" placeholder="Your Phone" style="height: 55px;">
                                    </div> <br>
                                    <div class="col-7">
                                        <input type="text" required=""  name="address" class="form-control border-0" placeholder="Your Address" style="height: 55px;">
                                    </div> <br>
                                    <div class="col-7">
                                        <input type="password" required=""  name="pass" class="form-control border-0" placeholder="Password" style="height: 55px;">
                                    </div> <br>
                                    <div class="col-5">
