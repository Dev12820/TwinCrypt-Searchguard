<%-- 
    Document   : TestServer
    Created on : Jan 13, 2023, 10:28:01 PM
    Author     : Murthi
--%>
        ...
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="TestServer.jsp" class="nav-item nav-link active">Test Server</a>
 ...
 <!-- Page Header Start -->
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Test Server</span></h1>
        </div>
        <div class="row gx-0 align-items-center">
            <center><div class="col-lg-6">
                <div class="contact-form bg-light p-5">
                     <form action="TSlog" method="post">
                    <div class="row g-3">
                        
                        <center><div class="col-7">
                                <input type="text" class="form-control border-0" name="name" placeholder="User Name" style="height: 55px;">
                        </div>
                            <br> 
                        <div class="col-7">
